...
int main(void){
	...
	unsigned short delta_theta = 15; //change this to change the angle increment
	...
	while (1){
		timer1_echo_config(); 
		_delay_ms(5); //this is required as well. Abdul do not remove this please
		object_distance = measure_distance();
		object_distance = measure_distance(); //THIS REPEAT IS INTENTIONAL
